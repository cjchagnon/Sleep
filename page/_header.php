...
// _header.php
//
// Header Template for medium + Large Screens
//
// Includes header
//=============================================================================
?>
<!--header for large screens -->
<div class="header-bar hide-for-small-only">
  <div class="default-brand">
    <img class="default-brand-logo shadow-d1" src="resources/img/sleep.png">
    <h1 class="default-brand-text">Sleep App</h1>
  </div>
  <div class="row expanded header-bar-links">
    <div class="row">
